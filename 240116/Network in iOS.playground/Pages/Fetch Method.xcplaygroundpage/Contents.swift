...
final class NetworkService {
    ...
    func fetchProfile(username : String, completion : @escaping (Result<GithubProfile, Error>) -> Void) {
        ...
        let task = session.dataTask(with: URL(string: "https://api.github.com/users/\(username)")! ){ data, response, error in
...
networkService.fetchProfile(username: "chldudqlsdl") { result in
    switch result {
